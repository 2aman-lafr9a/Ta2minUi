...
const SignupAgencyForm = () => {
  ...
  return (
    <div className="singupAgency"   style={
      {
      ...
      {step === 1 && (
          <><h2>SignUp</h2><form onSubmit={toStep2}>
            ...
            <div className="agency2">
              <div className="containerP">
                <div className="cardP cardP-1">
                  ...
                  <button type="button" className="select"  onClick={() => handlePlans(1)}>
                    Choose this plan
                  </button>
                </div>
                <div className="cardP cardP-2">
                  <h2>Premium</h2>
                  <h3>
                    0.05ETH<span>/mo.</span>
                  </h3>
                   <ul>
                    <li className="aval">10 offer</li>
                    <li className="aval">100 contract</li>
                  </ul>
                  <button type="button" className="select" onClick={() => handlePlans(2)}>
                ...
                <div className="cardP cardP-3">
                  ...
                  >
                    <button type="button" className="select"  onClick={() => handlePlans(3)} >
                      Choose this plan
                    </button>
                  </div>
                </div>
